...
import com.example.designactivity.databinding.ActivityMySavedDownloadsBinding
import com.example.designactivity.model.MediaModel

class MySavedDownloadsActivity : AppCompatActivity() {

    lateinit var binding: ActivityMySavedDownloadsBinding
    val list = ArrayList<MediaModel>()


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMySavedDownloadsBinding.inflate(layoutInflater)
